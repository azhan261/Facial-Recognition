...
database = {}
database["abc1"] = img_to_encoding("images/abc1.jpg", model)
database["abc2"] = img_to_encoding("images/abc2.jpg", model)
database["abc3"] = img_to_encoding("images/abc3.jpg", model)
